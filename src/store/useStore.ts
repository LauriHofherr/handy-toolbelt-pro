  ...
  persist(
    (set, get) => ({
      ...
      settings: {
        ...
        paymentMethodOrder: ['zelle', 'venmo', 'cash'],
        zelleContact: '',
        venmoHandle: '',
        defaultPaymentDueTerms: 'net-30',
        paymentInstructions: 'Please include invoice # in your Zelle memo.',
        estimateBoilerplate: 'Price valid for 30 days. Permit costs not included. Work area to be cleared by homeowner prior to start date.',
        invoiceBoilerplate: 'Thank you for your business! Payment due within stated terms. A 10% late fee applies after 7 days past due.',
        termsAndConditions: '',
        showSignatureLine: true,
        fromName: '',
        reminderSchedule: ['on-due'],
        overdueBadgeThreshold: 1,
        reminderMessageTemplate: 'Hi [Client Name], just a reminder that invoice #[Invoice #] for $[Amount] is due [Date]. Thank you!',
